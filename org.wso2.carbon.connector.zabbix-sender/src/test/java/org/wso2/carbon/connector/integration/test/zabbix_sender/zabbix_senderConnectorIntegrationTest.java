...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.zabbix_sender;
 ...
 */
public class zabbix_senderConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "zabbix_sender test case")
